            ...
            <div class="profile-content">
                <div class="tabbable-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a href="#tab_1_2" class="nav-link " data-toggle="tab" aria-expanded="true">Company & Bank Profile</a>
                        </li>
                        @if ($canChangeProfile)
                            <li class="nav-item">
                                <a href="#tab_1_4" class="nav-link" data-toggle="tab" aria-expanded="false">{{ trans('core/acl::users.change_password') }}</a>
                            </li>
                        @endif
