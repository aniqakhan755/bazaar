...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="ui-layout__item">
                            <div class="ui-banner ui-banner--status-warning">
                                ...
                                <div class="ui-banner__content">
                                    <h2 class="ui-banner__title"><?php echo e(trans('plugins/ecommerce::order.cancel_order')); ?></h2>
                                    <div class="ws-nm">
                                                            ...
                                                            <ul class="unstyled">
                                                                <li class="simple-note">
                                                                    ...
                                                                    <ul class="dom-switch-target line-item-properties small">
                                                                        ...
                                                                        <li class="ws-nm">
                                                                            <span class="bull">↳</span>
                                                                            <span class="black"><?php echo e(trans('plugins/ecommerce::order.warehouse')); ?></span>
                                                                            <span class="bold-light"><?php echo e($order->shipment->store->name ?? $defaultStore->name); ?></span>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                            ...
                                            <table class="table-normal table-none-border table-color-gray-text">
                                                ...
                                                <?php if(EcommerceHelper::isTaxEnabled()): ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right p-none-t pl10">
                                                            <p class="mb0"><?php echo e(format_price($order->tax_amount, $order->currency_id)); ?></p>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                                <tr>
                    ...
                    <div class="ui-layout__item">
                        <div class="wrapper-content mb20">
                            ...
                            <div class="next-card-section border-none-t">
                                <div class="mb5">
                                    <strong class="text-capitalize"><?php echo e($order->user->name ? $order->user->name : $order->address->name); ?></strong>
                                </div>
                                ...
                                <ul class="ws-nm text-infor-subdued">
                                    <li class="overflow-ellipsis"><a class="hover-underline" href="mailto:<?php echo e($order->user->email ? $order->user->email : $order->address->email); ?>"><?php echo e($order->user->email ? $order->user->email : $order->address->email); ?></a></li>
                                    <?php if($order->user->id): ?>
                        ...
                        <div class="wrapper-content bg-gray-white mb20">
                            <div class="pd-all-20">
                                <div class="p-b10">
                                    <strong><?php echo e(trans('plugins/ecommerce::order.warehouse')); ?></strong>
                                    <ul class="p-sm-r mb-0">
                                        <li class="ws-nm">
                                            <span class="ww-bw text-no-bold"><?php echo e($defaultStore->name ?? trans('plugins/ecommerce::order.default_store')); ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <?php echo Form::modalAction('update-shipping-address-modal', trans('plugins/ecommerce::order.update_address'), 'info', view('plugins/ecommerce::orders.shipping-address.form', ['address' => $order->address, 'orderId' => $order->id])->render(), 'confirm-update-shipping-address-button', trans('plugins/ecommerce::order.update'), 'modal-md'); ?>
...
<?php echo $__env->make('core/base::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\bazaar\platform/plugins/ecommerce/resources/views//orders/edit.blade.php ENDPATH**/ ?>