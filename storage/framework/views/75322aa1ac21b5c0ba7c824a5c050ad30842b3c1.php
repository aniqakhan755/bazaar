...
<?php $__env->startSection('content'); ?>
    <h4 class="text-center register-title"><?php echo e(trans('core/acl::auth.register_below')); ?></h4>
    <?php echo Form::open(['route' => 'vendor.register.post', 'class' => 'register-form','id'=>'vendor-register']); ?>

    <!-- progressbar -->
    <fieldset id="account-information">
        <div class="fieldset-heading"><?php echo e(trans('core/acl::auth.register.account_information')); ?>:</div>
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="firstNameGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.firstname')); ?></label>
                    <?php echo Form::text('first_name', old('first_name', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.firstname')]); ?>

                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="lastNameGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.lastname')); ?></label>
                    <?php echo Form::text('last_name', old('last_name', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.lastname')]); ?>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="emailGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.email')); ?></label>
                    <?php echo Form::text('email', old('email', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.email')]); ?>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="cnicGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.cnic')); ?></label>
                    <input type="text" name="cnic" class="cnic form-control form-control-sm" value="<?php echo e(old('cnic')); ?>">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="phoneGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.phone')); ?></label>
                    <input type="text" name="phone" class="phone_number_3 form-control form-control-sm"
                           value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(trans('core/acl::auth.register.phone')); ?>">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="userNameGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.username')); ?></label>
                    <?php echo Form::text('username', old('username', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.username')]); ?>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="passwordGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.login.password')); ?></label>
                    <?php echo Form::input('password', 'password', (app()->environment('demo') ? '159357' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.login.password')]); ?>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="confirmPasswordGroup">
                    <label
                        class="control-label required"><?php echo e(trans('core/acl::auth.register.confirm_password')); ?></label>
                    <?php echo Form::input('password', 'password_confirmation', (app()->environment('demo') ? '159357' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.confirm_password')]); ?>
        ...
        <input type="button" name="next" class="next action-button btn  btn-primary btn-style"
               value="<?php echo e(trans('core/acl::auth.register.next')); ?>"/>
    </fieldset>
    <fieldset id="company-information" style="display:none;">
        <div class="fieldset-heading"><?php echo e(trans('core/acl::auth.register.company_information')); ?>:</div>
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="companyNameGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.company_name')); ?></label>
                    <?php echo Form::text('company_name', old('company_name', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.company_name')]); ?>

                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="companyAddressGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.company_address')); ?></label>
                    <?php echo Form::text('company_address', old('company_address', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.company_address')]); ?>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="countryGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.country')); ?></label>
                    <div class="select--arrow">
                        <select name="country" class="form-control address-control-item" id="country">
                            <?php $__currentLoopData = ['' => __('Select Country')] + EcommerceHelper::getAvailableCountries(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countryCode => $countryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($countryName === 'Pakistan'): ?> selected <?php endif; ?> value="<?php echo e($countryName); ?>"><?php echo e($countryName); ?></option>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="cityGroup">
                    <label class="control-label required"><?php echo e(trans('core/acl::auth.register.city')); ?></label>
                    <div class="select--arrow">
                        <select name="city" class="form-control address-control-item" id="city">
                            <option value="">Select City</option>
                            <?php $__currentLoopData = EcommerceHelper::getAvailableCities(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cityName=> $cityName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cityName); ?>"><?php echo e($cityName); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <i class="fas fa-angle-down"></i>
                    </div>
            ...
            <div class="form-group" id="aboutCompanyGroup">
                <label class="control-label required"><?php echo e(trans('core/acl::auth.register.about_company')); ?></label>
                <textarea class="form-control form-control-sm" name="about_company" id="about_company" rows="6"  value="<?php echo e(old('about_company')); ?>" placeholder="<?php echo e(trans('core/acl::auth.register.about_company')); ?>" ></textarea>
            </div>
            </div>
        </div>
        <div class="fieldset-heading"><?php echo e(trans('core/acl::auth.register.bank_information')); ?>:</div>
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="bankNameGroup">
                    <label class="control-label"><?php echo e(trans('core/acl::auth.register.bank_name')); ?></label>
                    <?php echo Form::text('bank_name', old('bank_name', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.bank_name')]); ?>

                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="accountTitleGroup">
                    <label class="control-label"><?php echo e(trans('core/acl::auth.register.account_title')); ?></label>
                    <?php echo Form::text('account_title', old('account_title', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.account_title')]); ?>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="swiftCodeGroup">
                    <label class="control-label"><?php echo e(trans('core/acl::auth.register.swift_code')); ?></label>
                    <?php echo Form::text('swift_code', old('swift_code', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.swift_code')]); ?>

                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="form-group" id="ibanGroup">
                    <label class="control-label"><?php echo e(trans('core/acl::auth.register.account_iban')); ?></label>
                    <?php echo Form::text('account_iban', old('account_iban', app()->environment('demo') ? 'botble' : null), ['class' => 'form-control form-control-sm', 'placeholder' => trans('core/acl::auth.register.account_iban')]); ?>
        ...
        <button type="submit" class="btn btn-block login-button mr-2">
            <span class="signin"><?php echo e(trans('core/acl::auth.register.register')); ?></span>
        </button>
        <input type="button" name="previous"
               class="previous action-button-previous btn btn-md btn-style"
               value="<?php echo e(trans('core/acl::auth.register.previous')); ?>"/>
    </fieldset>

    <div class="clearfix"></div>

    <br>
    <p><a class="lost-pass-link" href="<?php echo e(route('access.password.request')); ?>"
          title="<?php echo e(trans('core/acl::auth.already_have_account')); ?>"><?php echo e(trans('core/acl::auth.already_have_account')); ?></a>
    </p>
...
<?php $__env->startPush('footer'); ?>
    <script src="<?php echo e(asset('js/js-validation.js')); ?>"></script>
...
<?php echo $__env->make('core/acl::auth.master-register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\bazaar\platform/core/acl/resources/views//auth/vendor-register.blade.php ENDPATH**/ ?>