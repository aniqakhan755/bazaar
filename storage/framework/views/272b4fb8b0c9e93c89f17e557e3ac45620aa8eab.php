        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu">
                    <?php if( Auth::user()->roles[0]->slug != 'vendor'): ?>
                    ...
                    <?php else: ?>
                        <li><a href="<?php echo e(route('vendors.profile.view', Auth::user()->getKey())); ?>"><i class="icon-user"></i> <?php echo e(trans('core/base::layouts.profile')); ?></a></li>
                    <?php endif; ?>
...
<?php /**PATH C:\Apache24\htdocs\bazaar\platform/core/base/resources/views//layouts/partials/top-menu.blade.php ENDPATH**/ ?>